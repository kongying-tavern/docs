...
除非您已阅读并接受本协议所有条款，否则您无权使用空荧酒馆相关服务。您点击同意、接受或下一步，或您注册、使用空荧酒馆原神地图用户服务协议均视为您已阅读并同意签署本协议。
...
您可以通过 [yuanshenmap@gmail.com](mailto:yuanshenmap@gmail.com) 向我们报告协议问题或者就本用户协议提出问题、意见和请求。
