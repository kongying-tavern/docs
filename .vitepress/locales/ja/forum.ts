...
const forum: CustomConfig['forum'] = {
  ...
  auth: {
    login: 'ログイン',
    logout: 'ログアウト',
    loginMsg: 'Giteeアカウントでログイン',
    logoutMsg: 'Giteeアカウントからログアウト',
    loginTips: 'ログインしてから再試行してください',
    loginToCheck: '%login して確認してください (・ω・)',
    jumpToGiteeTips: 'Giteeでログイン認証します',
    loginSuccess: 'ログイン成功',
    logoutSuccess: 'ログアウトしました',
    loginFail: 'ログイン失敗',
    logoutFail: 'ログアウト失敗',
    loginAlert: 'ログイン通知',
    loginAlertMsg: 'Giteeでログイン認証します',
    notGiteeAccountMsg: 'Giteeアカウントがありませんか？%signup',
    clickToGiteeSignup: 'Gitee登録はこちら',
  },
  aside: {
    contactUs: {
      title: 'お問い合わせ',
