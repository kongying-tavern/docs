...
![](/imgs/en/manual/overlay-mode/1.png) (Map client displaying on game Window)
...
![](/imgs/en/manual/overlay-mode/2.png) (Overlay Mode enabled Tip)
...
![](/imgs/en/manual/overlay-mode/3.png) (Close Button - Go Back to Game)
...
![](/imgs/en/manual/overlay-mode/4.png) (Paimon Icon)
...
![](/imgs/en/manual/overlay-mode/5.png) (Modify Switching Shortcut)
