...
![](/imgs/kr/manual/auto-tracking/6.png)
...
![](/imgs/kr/manual/auto-tracking/3.png)
![](/imgs/kr/manual/auto-tracking/4.png)
![](/imgs/kr/manual/auto-tracking/5.png)

[#]: # '与第 3 步一样，更新了客户端内一键清理的步骤和图片'

若依然如此，请删除 `%APPDATA%\..\LocalLow\空荧酒馆\Map\DLL` 中的文件，并重新下载

![](/imgs/kr/manual/auto-tracking/1.png)
...
![](/imgs/kr/manual/auto-tracking/windowedoptimization.png)
