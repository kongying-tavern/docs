...
const isTeamMember = userInfo.isTeamMember()
...
<template>
    ...
    <Tabs v-model="type" class="w-full m-auto px-4">
      <DialogHeader>
        <TabsList
          ...
          :class="isTeamMember ? 'grid-cols-4' : 'grid-cols-3'"
        >
          <TabsTrigger
  ...
  <Dialog v-if="isDesktop" v-model:open="isOpen">
    <DialogContent
      class="flex items-center flex-col max-w-[clamp(50vw,500px,90vw)] mb-70px"
    >
      <VisuallyHidden>
        <DialogTitle>
