...
由于手柄的GUI尺寸略小，只有键鼠尺寸的85%，其中的信息损失可能会导致追踪质量轻微下降，目前发现在空之神殿的部分地区追踪会比较困难

考虑大部分玩家是键鼠玩家，所以追踪的特征点尺度更接近于键鼠的GUI大小

如果发现部分位置虽然特征比较明显，但定位比较困难，可以临时切换为键鼠操作模式

未来打算在2K以上分辨率修复这个问题，但如果屏幕尺寸依然是1080p则暂时无法解决手柄Ui尺寸导致的追踪质量轻微下降的问题
...
目前追踪的WGC（DirectX）已对HDR显示器进行适配，目前支持官方HDR、Windows Auto HDR、RTX HDR

已知限制，HDR截图需要消耗更多的性能，在较低端的设备可能卡顿，如果遇到这个问题建议在SDR下使用

其他显卡的HDR功能尚未测试，自测时可以在“设置>位置追踪>追踪截图”获取，然后在“设置>位置追踪>截图目录”中查看颜色是否正确
...
以上问题在6.5.1版本之后得到了解决，但出现瞬移依然可以通过以下方式排查。
