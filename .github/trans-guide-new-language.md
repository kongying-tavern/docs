...
- 已在[翻译认领看板](https://github.com/kongying-tavern/docs/issues/555) 评论 `/claim` 认领（**15 日内提交首个 PR**，逾期自动释放）
...
3. 在[翻译认领看板](https://github.com/kongying-tavern/docs/issues/555) 评论 `/claim 文件路径` 认领待翻译文件（可一次认领多个，也可整目录认领）
...
- [翻译认领看板](https://github.com/kongying-tavern/docs/issues/555) —— 认领待翻译文件（评论 `/claim`）
